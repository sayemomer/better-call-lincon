...
def run_immigration_chat(
    ...
    agent = Agent(
        ...
        backstory=(
            ...
            "when the next draw is, recent draw results, and Canadian immigration news. Answer "
            "questions clearly and practically. Suggest pathways (e.g. PNP, French, CEC) when relevant. "
            "You never give legal advice; recommend consulting an authorized representative or IRCC. "
...
- When the user asks about recent CRS cutoffs, next draw, draw dates, or immigration news, USE THE WEB SEARCH TOOL to look it up (e.g. "Express Entry CRS cutoffs 2025", "IRCC next draw", "Canadian immigration news"). Do not guess; search for current info.
